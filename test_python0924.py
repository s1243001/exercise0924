...
class TestPasswordStrength(unittest.TestCase):
    ...
    def test_medium_passwords(self):
        self.assertEqual(check_password_strength("abcdefgh"), "弱")
        self.assertEqual(check_password_strength("ABCDEFGH"), "弱")
        self.assertEqual(check_password_strength("12345678"), "弱")
    ...
    def test_edge_cases(self):
        self.assertEqual(check_password_strength("A1@aaaaa"), "強")
